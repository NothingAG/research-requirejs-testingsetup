/*
 * gameQuery rev. 0.7.1-hacked
 *
 * Copyright (c) 2012 Selim Arsever (http://gamequeryjs.com)
 * licensed under the MIT-License
 *
 * HACKED: Tobias Leugger <vibes@nothing.ch> Added a check around line 1556 to
 * only apply DXImageTransform.Microsoft.Matrix filter if it is needed (if an
 * element is either rotated or scaled). This improves performance in old IE
 * versions and doesn't break PNG alpha channel in IE8.
 * Pull request submitted: https://github.com/onaluf/gameQuery/pull/23
 */
